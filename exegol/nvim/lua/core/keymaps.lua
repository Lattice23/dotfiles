...
-- wrapping
keymap.set("v", "<leader>wu", ":g!/^\\s*$/normal vipJ<CR>", { desc = "Unwrap paragraph selection" })
keymap.set("v", "<leader>ww", ":norm gqq<CR>", { desc = "wrap paragraph selection" })
...
-- kakoune
-- keymap.set("n", "w", "vw<Esc>", { noremap = true })
-- keymap.set("n", "b", "vb<Esc>", { noremap = true })
-- keymap.set("n", "e", "ve<Esc>", { noremap = true })
-- keymap.set("n", "ge", "vge<Esc>", { noremap = true })
