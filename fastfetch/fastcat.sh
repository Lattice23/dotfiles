...
'
  ...
  if [[ $islem == 1 || $islem == 01 ]]; then
    clear
    $SHELL /home/lattice/extras/FastCat/Small-Themes/start.sh
  elif [[ $islem == 2 || $islem == 02 ]]; then
    clear
    $SHELL /home/lattice/extras/FastCat/Large-Themes/start.sh
...
'
    ...
    $SHELL /home/lattice/extras/FastCat/backup.sh
  else
